...
import (
	...
	"github.com/jackmcguire1/riot-rankings/api/tournament_rankings"
...
func main() {
	...
	r := mux.NewRouter()
	r.HandleFunc("/", tournamentsRankingHandler.GetTournamentRankings)
	r.PathPrefix("/").HandlerFunc(tournamentsRankingHandler.GetTournamentRankings)
