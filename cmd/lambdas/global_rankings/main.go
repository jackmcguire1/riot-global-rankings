...
import (
	...
	"github.com/jackmcguire1/riot-rankings/api/global_rankings"
...
func main() {
	...
	r := mux.NewRouter()
	r.HandleFunc("/", globalRankingHandler.GetGlobalRankings)
	r.PathPrefix("/").HandlerFunc(globalRankingHandler.GetGlobalRankings)
